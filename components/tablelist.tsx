...
import { Button, Input, SelectContent, SelectItem, SelectTrigger, SelectValue, Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui";
...
return (
    <div className={cn(className)} style={{left: '300px', maxHeight: '80vh', overflowY: 'auto' }}>
        <div className="flex justify-between items-center">
      
            {/* <h2 className="text-lg font-bold bg-gray-200 bg-opacity-50 rounded p-3">{title}</h2> */}
